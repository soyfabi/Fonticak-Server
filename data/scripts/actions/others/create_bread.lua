...
local create_bread = Action()
function create_bread.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
create_bread:id(2692, 2694)
create_bread:register()
