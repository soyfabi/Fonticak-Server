local large_sea = Action()
function large_sea.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if player:getStorageValue(8456453) <= os.time() then
		...
		item:transform(7553)
		item:decay()
		player:setStorageValue(8456453, os.time() + 20 * 60 * 60)
