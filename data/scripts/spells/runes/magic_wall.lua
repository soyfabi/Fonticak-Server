...
function onCreateMagicWall(creature, tile)
	...
	item:setAttribute(ITEM_ATTRIBUTE_DURATION, math.random(19000, 19000))
	item:setAttribute(ITEM_ATTRIBUTE_DESCRIPTION, "Casted by: ".. creature:getName() ..".")
end
